<html lang="en" class="dark"><!-- BEGIN: Head -->
<head>
    <style>
        :root {
...
*/
    ...
    <script type="text/javascript" charset="UTF-8"
            src="https://maps.googleapis.com/maps-api-v3/api/js/54/2/intl/ru_ALL/common.js"></script>
    <script type="text/javascript" charset="UTF-8"
            src="https://maps.googleapis.com/maps-api-v3/api/js/54/2/intl/ru_ALL/util.js"></script>
</head>
<!-- END: Head -->
