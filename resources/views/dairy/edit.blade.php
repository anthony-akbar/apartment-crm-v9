...
<div class="text-center">
    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#record" class="btn btn-primary">Новая запись</a>
</div>
<!-- END: Modal Toggle -->

<!-- BEGIN: Modal Content -->
<div id="record" class="modal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="{{ route('dairy.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Расходы</h2>
                ...
                <div class="modal-body gap-4 gap-y-3">
                    <div class="mt-3">
                        <div class="grid grid-cols-3 mx-auto">
                            ...
                            <div class="grid-cols-2 px-5">
                                <input  value="{{ old('buy', $product->buy) }}" name="date" type="text" class="datepicker form-control w-56 block mx-auto" data-single-mode="true">
                            </div>
                        </div>
                    </div>
                    <div class="mt-3">
                        <label for="rep" class="form-label">Ответственное лицо</label>
                        <input id="rep" type="text" name="representative" class="form-control" placeholder="Ответственное лицо" required>
                    </div>

                    <div class="mt-3">
                        <label for="details" class="form-label">Детали</label>
                        <input id="details" type="text" name="details" class="form-control" placeholder="Details" required>
                    </div>
                    ...
                    <div class="col-span-12 sm:col-span-6 mt-3">
                        <label for="description" class="form-label w-full flex flex-col sm:flex-row">Дополнительная информация
                        </label>
                ...
                <div class="modal-footer">
                    <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-20 mr-1">Отменить</button>
