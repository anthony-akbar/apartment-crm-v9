    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
            ...
            <div id="dairy_som_in" class="hidden xl:block mx-auto text-slate-500">
                Приход: {{ $dairy_som_in }} Сом
            </div>
            <div id="dairy_som_out" class="hidden xl:block mx-auto text-slate-500">
                Расход {{ $dairy_som_out }} Сом
            </div>
            <div id="dairy_dollar_subtotal" class="hidden xl:block mx-auto text-slate-500">
                Остаток {{ $dairy_som_in-$dairy_som_out }} Сом
            </div>
            <div class="hidden xl:block mx-auto text-slate-500">
            </div>
                        ...
                        <td class="text-center table-report__action">
                            <div class="flex justify-center items-center">
                                ...
                                <a href="javascript:;" data-tw-toggle="modal"
                                   data-tw-target="#delete-record{{ $item->id }}" class="flex items-center text-danger">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                <div class="p-5 text-center">
                                                    ...
                                                    <div class="text-slate-500 mt-2">Вы уверены что хотите удалить
                                                        запись? <br>Это действие необратимо.
                                                    </div>
                                                </div>
                                                <div class="px-5 pb-8 text-center">
                                                    <form action="{{ route('safe.delete', $item->id) }}" method="POST">
                                                        ...
                                                        <button type="button" data-tw-dismiss="modal"
                                                                class="btn btn-outline-secondary w-24 mr-1">Отменить
                                                        </button>
                                                        <button type="submit" class="btn btn-danger w-24">Удалить
                                                        </button>
                                                    </form>
                                                </div>
                                            </div>
