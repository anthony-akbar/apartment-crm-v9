...
@section('content')
    <div class="intro-y flex flex-col sm:flex-row items-center p-10">
        <h2 class="text-lg font-medium mr-auto">Брони коммерческого помещения</h2>
    </div>

    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a href="{{ route('booking.commercial.create') }}" class="btn btn-primary shadow-md mr-2">Новая бронь</a>
        <div class="dropdown">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        @include('booking.commercials.table')
    </div>
