<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap px-10 items-center mt-2">
        <div class="hidden xl:block mx-auto text-slate-500">
            Баланс {{ $safe_dollar_in-$safe_dollar_out }} $
        </div>
        <div class="w-full xl:w-auto flex items-center mt-3 xl:mt-0">
            <a href="{{ route('dairies.export') }}" class="btn btn-primary shadow-md mr-2"
