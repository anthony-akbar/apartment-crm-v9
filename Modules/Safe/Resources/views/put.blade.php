...
<div class="text-center">
    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#put"
       class="btn btn-primary">Ввод</a>
</div>
<!-- END: Modal Toggle -->

<!-- BEGIN: Modal Content -->
<div id="put" class="modal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="{{ route('safe.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Ввод средств в сейф</h2>
