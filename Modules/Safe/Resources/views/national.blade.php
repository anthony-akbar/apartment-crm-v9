<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center px-10 items-center mt-2">
        <div class="hidden xl:block mx-auto text-slate-500">Баланс {{ $safe_som_in-$safe_som_out }} Сом</div>
        <div class="w-full xl:w-auto flex items-center mt-3 xl:mt-0">
            <button onclick="htmlTableToExcel()" class="btn btn-primary shadow-md mr-2"
...
<div class="intro-y px-5 mt-5 col-span-12 overflow-auto 2xl:overflow-visible">
    <div id="national-content">

        <table class="table table-report -mt-2" id="tblToExcl">
            <thead class="box">
            <tr>
            ...
            @foreach($safe_som as $item)

                <tr class="intro-x">
                    <td class="text-center">
                        <a href=""
                           class="underline decoration-dotted whitespace-nowrap">{{ $item->date }}</a>
                    </td>
                    <td class="text-center">
                    ...
                    <td class="text-center">
                        <div
                            class="whitespace-nowrap">{{$item->payment}} {{ $item->currency == 'C' ? 'Сом' : $item->currency }}</div>
                    </td>
                    <td class="text-center">
                    ...
                    <td class="text-center table-report__action">
                        <div class="flex justify-center items-center">
                            ...
                            <a href="javascript:;" data-tw-toggle="modal"
                               data-tw-target="#delete-record{{ $item->id }}"
                            ...
                            <!-- END: Modal Toggle -->
                            <!-- BEGIN: Modal Content -->
                            <div id="delete-record{{ $item->id }}" class="modal" tabindex="-1"
                                 aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body p-0">
                                            <div class="p-5 text-center">
                                                ...
                                                <div class="text-slate-500 mt-2">Вы уверены что хотите
                                                    удалить запись? <br>Это действие необратимо.
                                                </div>
                                            </div>
                                            <div class="px-5 pb-8 text-center">
                                                <form action="{{ route('safe.delete', $item->id) }}"
                                                      method="POST">
                                                    @csrf
