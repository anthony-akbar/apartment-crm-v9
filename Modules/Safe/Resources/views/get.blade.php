...
<div class="text-center">
    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#get"
       class="btn btn-primary">Вывод</a>
</div>
<!-- END: Modal Toggle -->

<!-- BEGIN: Modal Content -->
<div id="get" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('safe.get') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- BEGIN: Modal Header -->
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Вывод средств из сейфа</h2>
